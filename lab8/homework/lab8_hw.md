...
```
## here() starts at /Users/nishiro/Desktop/BIS 015L/BIS15W2022_sbian
```
...
No. They are in long form. The data frame become very long and hard to read because in one site there are so many enterococci tests on different date.
